...
if __name__ == "__main__":
        ...
        experiments: list[Experiment] = Experiment.read_experiments('1/31bonds/custom_working_portfolio/')
        ...
        for xp in experiments:
            ...
            if 'gabriele-agliardi' in xp.lp_file:
                # Someone else's system path
                lp_file = xp.lp_file.replace('/home/gabriele-agliardi/data/Client-Vanguard-Optimization', str(ROOT))
            else:
                # Your system - use path as-is
                lp_file = xp.lp_file
