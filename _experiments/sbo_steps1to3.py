...
if __name__ == '__main__':
    ...
    # execute_multiple_runs(**doe['converted/esg_constrained_31assets_esg7.0'], instance='', run_on_serverless=False)
    # execute_multiple_runs(**doe['manual/portfolio_test'], instance='', run_on_serverless=False)
    # execute_multiple_runs(**doe['custom/working_portfolio'], instance='', run_on_serverless=False)
